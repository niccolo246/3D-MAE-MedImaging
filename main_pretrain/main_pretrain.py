...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='/SAN/medic/SatsumaData/niccolo_data/foundation_save/model_transfrm_large_40pc/1checkpoint-75.pth',  #'',  
    ...
    parser.set_defaults(pin_mem=True)#True
