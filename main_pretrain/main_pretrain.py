...
from datasets_three_d import Custom3DDataset
from monai.transforms import Compose, RandAffine, RandFlip, ToTensor, NormalizeIntensity, EnsureType
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='mae_vit_large_patch16_reconstruct', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='./example_paths_pretrain.txt', type=str,
                        help='dataset path')
    parser.add_argument('--output_dir', default='output_dir', # fill this
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='log_dir', # fill this
    ...
    # If utilising pre-trained ImageNet:
    parser.add_argument('--finetune', default="",  # insert model weights here to for pretrained
...
def main(args):
    ...
    dataset_train = Custom3DDataset(args.data_path, transform=transform_train)

    if args.distributed:  # orig: if True
